...
import dancerIcon from '../../assets/dancer/Dancer_icon.png'
...
import plenaryIndulgence from '../../assets/white_mage/Plenary_Indulgence.png'
import whiteMageIcon from '../../assets/white_mage/White_frame_icon.png'
...
import pictoIcon from '../../assets/picto/Pictomancer_icon.png'
...
import gunbreakerIcon from '../../assets/gunbreaker/Gunbreaker_icon.png'
...
import darkKnightIcon from '../../assets/dark_knight/Dark_Knight_icon.png'
...
import warriorIcon from '../../assets/warrior/Warrior_icon.png'
...
import astrologianIcon from '../../assets/astrologian/Astrologian_icon.png'
...
import paladinIcon from '../../assets/paladin/Paladin_icon.png'

import mantra from '../../assets/monk/Mantra.png'
import monkIcon from '../../assets/monk/Monk_icon.png'

import arcaneCrest from '../../assets/Reaper/Arcane_Crest.png'
import reaperIcon from '../../assets/Reaper/Reaper_icon.png'

import naturesMinne from '../../assets/bard/Natures_Minne.png'
import troubadour from '../../assets/bard/Troubadour.png'
import bardIcon from '../../assets/bard/Bard_icon.png'

import ninjaIcon from '../../assets/ninja/Ninja_icon.png'

import dismantle from '../../assets/machinist/Dismantle.png'
import tactician from '../../assets/machinist/Tactician.png'
import machinistIcon from '../../assets/machinist/Machinist_icon.png'

import magickBarrier from '../../assets/red_mage/Magick_Barrier.png'
import redMageIcon from '../../assets/red_mage/Red_Mage_icon.png'

import summonerIcon from '../../assets/summoner/Summoner_icon.png'
...
import viperIcon from '../../assets/viper/Viper_icon.png'

export type JobKey = keyof typeof jobSkills
export type JobRole = 'tank' | 'healer' | 'melee' | 'caster' | 'ranged'
...
export const allJobs: {
  ...
  { id: '0', job: 'GNB', img: gunbreakerIcon, role: 'tank' },
  { id: '1', job: 'DRK', img: darkKnightIcon, role: 'tank' },
  { id: '2', job: 'PLD', img: paladinIcon, role: 'tank' },
  { id: '3', job: 'WAR', img: warriorIcon, role: 'tank' },
  { id: '4', job: 'SGE', img: sageIcon, role: 'healer' },
  { id: '5', job: 'SCH', img: scholarIcon, role: 'healer' },
  { id: '6', job: 'AST', img: astrologianIcon, role: 'healer' },
  { id: '7', job: 'WHM', img: whiteMageIcon, role: 'healer' },
  { id: '8', job: 'VPR', img: viperIcon, role: 'melee' },
  { id: '9', job: 'SAM', img: samuraiIcon, role: 'melee' },
  { id: '10', job: 'NIN', img: ninjaIcon, role: 'melee' },
  { id: '11', job: 'DRG', img: dragoonIcon, role: 'melee' },
  { id: '12', job: 'RPR', img: reaperIcon, role: 'melee' },
  { id: '13', job: 'MNK', img: monkIcon, role: 'melee' },
  { id: '14', job: 'PCM', img: pictoIcon, role: 'caster' },
  { id: '15', job: 'BLM', img: blackMageIcon, role: 'caster' },
  { id: '16', job: 'SMN', img: summonerIcon, role: 'caster' },
  { id: '17', job: 'RDM', img: redMageIcon, role: 'caster' },
  { id: '18', job: 'DNC', img: dancerIcon, role: 'ranged' },
  { id: '19', job: 'BRD', img: bardIcon, role: 'ranged' },
  { id: '20', job: 'MCH', img: machinistIcon, role: 'ranged' }
]
